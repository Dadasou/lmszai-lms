<style>
    :root {
        ...
        @if (get_option('app_color_design_type') == 2)
            --kindergarten-yellow: {{ empty(get_option('kindergarten_app_theme_color')) ? '#ffc014' : get_option('kindergarten_app_theme_color') }};
            --kindergarten-price-toggle-btn: {{ empty(get_option('kindergarten_app_theme_color')) ? '#ffc014' : get_option('kindergarten_app_theme_color') }};
            --color-yellow: {{ empty(get_option('kindergarten_app_theme_color')) ? '#ffc014' : get_option('kindergarten_app_theme_color') }};
            --kindergarten-para-text: {{ empty(get_option('kindergarten_app_body_font_color')) ? '#288f8a' : get_option('kindergarten_app_body_font_color') }};
            --kindergarten-primary: {{ empty(get_option('kindergarten_theme_primary_color')) ? '#101828' : get_option('kindergarten_theme_primary_color') }};
            --kindergarten-secondary: {{ empty(get_option('kindergarten_theme_secondary_color')) ? '#288f8a' : get_option('kindergarten_theme_secondary_color') }};
            --kindergarten-secondary-light: {{ empty(get_option('kindergarten_theme_bg_secondary_color')) ? '#d9fbf9' : get_option('kindergarten_theme_bg_secondary_color') }};
        @endif
    }
</style>
