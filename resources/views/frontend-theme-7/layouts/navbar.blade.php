...
<div class="landing-menu landing-header-kindergarten">
    <section class="menu-section-area @auth isLoginMenu @endauth">
        <!-- Navigation -->
        <nav
            class="navbar sticky-header navbar-expand-lg {{ request()->route()->getName() == 'main.index'? 'nav-home': '' }}"
            id="mainNav">
                                    ...
                                    @foreach ($categories as $category)
                                        <li>
                                            <a href="{{ route('category-courses', $category->slug) }}"
                                               class="dropdown-item @if (count($category->subcategories) > 0) dropdown-toggle @endif">{{ __($category->name) }}</a>
                                            @if (count($category->subcategories) > 0)
                                                <ul class="submenu dropdown-menu">
                                                    @foreach ($category->subcategories as $subcategory)
                                                        <li><a class="dropdown-item"
                                                               href="{{ route('subcategory-courses', $subcategory->slug) }}">{{ __($subcategory->name) }}</a>
                                                        </li>
                                                    @endforeach
                                                </ul>
                                            @endif
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item"
                                                               href="{{ route('student.chat.index') }}">
                                                                <span class="iconify"
                                                                      data-icon="ic:outline-chat"></span>
                                                                {{ __('Chat') }}</a>
                                                        </li>
                                                    @endif
                                                    <li><a class="dropdown-item"
                                                           href="{{ route('student.wishlist') }}"><span class="iconify"
                                                                                                        data-icon="bx:bx-heart"></span>{{ __('Wishlist') }}
                                                        </a>
                                                    </li>
