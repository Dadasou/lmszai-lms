                                ...
                                <a href="{{ route('category-courses', $category->slug) }}">
                                    <div class="top-categories-item">
                                        ...
                                        <div class="content">
                                            ...
                                            <p class="text">{{__('OVER')}} {{$category->courses->count()}}+ {{__('COURSE')}}</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                <div class="top-instructor-item-one position-relative">
                                    ...
                                    <div class="content">
                                        ...
                                        @if(($currencyPlacement ?? get_currency_placement()) == 'after')
                                            @php $hourly_fee = $user->hourly_rate . ' ' . get_currency_symbol() . '/h'; @endphp
                                        @else
                                            @php $hourly_fee =  get_currency_symbol() . ' ' . $user->hourly_rate . '/h'; @endphp
                                        @endif
                                        <button type="button"
                                                ...
                                                class="btn-fill-kindergarten linkBtn bookSchedule"
                                                ...
                                                <div class="d-flex align-items-center g-10">
                                                    ...
                                                    @else
                                                        <h4 class="planPrice planPrice-monthly-amount">
                                                            ...
                                                            @else
                                                                {{ $currencySymbol ?? get_currency_symbol() }}{{ $priceMonthly }}
                                                            @endif
                                                        </h4>
                                                        @if($priceMonthly != $oldPriceMonthly)
                                                            <h4 class="planPrice planPrice-monthly-amount text-decoration-line-through fs-14 lh-14 text-kindergarten-para-text">
                                                                @if(($currencyPlacement ?? get_currency_placement()) === 'after')
                                                                    {{ $oldPriceMonthly }}{{ $currencySymbol ?? get_currency_symbol() }}
                                                                @else
                                                                    {{ $currencySymbol ?? get_currency_symbol() }}{{ $oldPriceMonthly }}
                                                                @endif
                                                            </h4>
                                                        @endif
                                                    @endif
                                                    ...
                                                    @else
                                                        <h4 class="planPrice planPrice-yearly-amount">
                                                            ...
                                                            @else
                                                                {{ $currencySymbol ?? get_currency_symbol() }}{{ $priceYearly }}
                                                            @endif
                                                        </h4>
                                                        @if($priceYearly != $oldPriceYearly)
                                                            <h4 class="planPrice planPrice-yearly-amount text-decoration-line-through fs-14 lh-14 text-kindergarten-para-text">
                                                                @if(($currencyPlacement ?? get_currency_placement()) === 'after')
                                                                    {{ $oldPriceYearly }}{{ $currencySymbol ?? get_currency_symbol() }}
                                                                @else
                                                                    {{ $currencySymbol ?? get_currency_symbol() }}{{ $oldPriceYearly }}
                                                                @endif
                                                            </h4>
                                                        @endif
                                                    @endif
