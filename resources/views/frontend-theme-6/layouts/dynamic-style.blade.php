<style>
    ...
    @else
        ...
        --meditation-primary: {{ empty(get_option('meditation_app_theme_color')) ? '#0c0c0d' : get_option('meditation_app_theme_color') }};
        --meditation-testi-bg-20: {{ empty(get_option('meditation_app_theme_secondary_color')) ? 'rgba(254, 202, 184, 0.2)' : get_option('meditation_app_theme_secondary_color') }};
        --meditation-price-toggle: {{ empty(get_option('meditation_app_theme_secondary_color')) ? 'rgba(254, 202, 184, 0.2)' : get_option('meditation_app_theme_secondary_color') }};
        --meditation-para-text: {{ empty(get_option('meditation_app_body_font_color')) ? '#7c7c7c' : get_option('meditation_app_body_font_color') }};
        --meditation-red: {{ empty(get_option('meditation_red_color')) ? '#ee5e37' : get_option('meditation_red_color') }};
        --meditation-blue: {{ empty(get_option('meditation_blue_color')) ? '#46d3ff' : get_option('meditation_blue_color') }};
        --meditation-yellow: {{ empty(get_option('meditation_yellow_color')) ? '#d8f87f' : get_option('meditation_yellow_color') }};
        --meditation-overlay-default: linear-gradient(180deg, rgba(251, 109, 104, 0) 0%, {{ empty(get_option('meditation_red_color')) ? '#ee5e37' : get_option('meditation_red_color') }} 100%);
        --meditation-overlay-blue: linear-gradient(180deg, rgba(70, 211, 255, 0) 0%, {{ empty(get_option('meditation_blue_color')) ? '#46d3ff' : get_option('meditation_blue_color') }} 100%);
        --meditation-overlay-yellow: linear-gradient(180deg, rgba(216, 248, 127, 0) 0%, {{ empty(get_option('meditation_yellow_color')) ? '#d8f87f' : get_option('meditation_yellow_color') }} 100%);
        --meditation-hero-banner-gradient: @if(empty(get_option('meditation_gradiant_banner_color'))) linear-gradient(180deg, rgba(254, 202, 184, 0.6) 0%, rgba(248, 246, 240, 1) 100%) @else {!! get_option('meditation_gradiant_banner_color') !!} @endif;
        --meditation-video-gradient: @if(empty(get_option('meditation_gradiant_video_banner_color'))) linear-gradient(180deg, rgba(251, 109, 104, 0) 0%, rgb(251, 109, 104) 100%) @else {!! get_option('meditation_gradiant_video_banner_color') !!} @endif;
        --meditation-core-feature-gradient: @if(empty(get_option('meditation_gradiant_core_feature_color'))) linear-gradient(180deg, rgb(12, 12, 13) 0%, rgb(52, 29, 16) 100%) @else {!! get_option('meditation_gradiant_core_feature_color') !!} @endif;
    @endif
}
</style>
