...
@section('breadcrumb')
    <div class="page-banner-content text-center">
        <h3 class="page-banner-heading text-white pb-15"> {{__('Zoom Settings')}} </h3>

        <!-- Breadcrumb Start-->
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb justify-content-center">
                <li class="breadcrumb-item font-14"><a href="{{route('organization.dashboard')}}">{{__('Dashboard')}}</a></li>
                <li class="breadcrumb-item font-14 active" aria-current="page">{{__('Zoom Settings')}}</li>
            </ol>
        </nav>
    </div>
@endsection
...
@section('content')
    <div class="instructor-profile-right-part">
        <form method="POST" action="{{route('organization.zoom-setting.update')}}">
            @csrf
            <div class="instructor-profile-info-box">
                <div class="instructor-my-courses-title d-flex justify-content-between align-items-center">
                    <h6>{{ __('Zoom Settings') }}</h6>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6 mb-30">
                        ...
                        <input type="text" name="api_key" value="{{@$zoom->api_key}}" class="form-control" placeholder="{{__('Zoom Client ID')}}">
                    ...
                    <div class="col-md-6 mb-30">
                        ...
                        <input type="text" name="api_secret" value="{{@$zoom->api_secret}}" class="form-control" placeholder="{{__('Zoom Client Secret')}}">
                    ...
                    <div class="col-md-6 mb-30">
                        ...
                        <select name="timezone" class=" select2">
                            <option value="{{ @$zoom->timezone }}"> {{ @$zoom->timezone }}</option>
                            ...
                            <option value="Australia/Broken_Hill">(GMT+9:30) Australia/Broken_Hill (Central Standard Time (South Australia/New South Wales))
                            </option>
                        ...
                        @if ($errors->has('timezone'))
                            <span class="text-danger"><i class="fas fa-exclamation-triangle"></i> {{ $errors->first('timezone') }}</span>
                        @endif
                    </div>
                    <div class="col-md-6 mb-30">
                        ...
                        <select name="status" id="status" class="">
                            ...
                            <option value="1" {{ @$zoom->status == 1 ? 'selected' : '' }}>{{ __('Active') }}</option>
                            <option value="0" {{ @$zoom->status != 1 ? 'selected' : '' }}>{{ __('Disable') }}</option>
                        </select>
                    ...
                    <div class="col-md-6 mb-30">
                        <label class="font-medium font-15 color-heading">{{__('Host Video')}}</label>
                        <select name="host_video" id="host_video" class="">
                            <option value="">{{__('Select Option')}}</option>
                            <option value="1" {{ @$zoom->host_video == 1 ? 'selected' : '' }}>{{ __('Enable') }}</option>
                            <option value="0" {{ @$zoom->host_video != 1 ? 'selected' : '' }}>{{ __('Disable') }}</option>
                        </select>
                    </div>
                    <div class="col-md-6 mb-30">
                        <label class="font-medium font-15 color-heading">{{__('Participant Video')}}</label>
                        <select name="participant_video" id="participant_video" class="">
                            <option value="">{{__('Select Option')}}</option>
                            <option value="1" {{ @$zoom->participant_video == 1 ? 'selected' : '' }}>{{ __('Enable') }}</option>
                            <option value="0" {{ @$zoom->participant_video != 1 ? 'selected' : '' }}>{{ __('Disable') }}</option>
                        </select>
                    </div>
                    <div class="col-md-6 mb-30">
                        <label class="font-medium font-15 color-heading">{{__('Waiting Room')}}</label>
                        <select name="waiting_room" id="waiting_room" class="">
                            <option value="">{{__('Select Option')}}</option>
                            <option value="1" {{ @$zoom->waiting_room == 1 ? 'selected' : '' }}>{{ __('Enable') }}</option>
                            <option value="0" {{ @$zoom->waiting_room != 1 ? 'selected' : '' }}>{{ __('Disable') }}</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 d-flex justify-content-end">
                <button type="submit" class="theme-btn theme-button1 theme-button3 font-15 fw-bold">{{__('Save')}}</button>
            </div>
        </form>
