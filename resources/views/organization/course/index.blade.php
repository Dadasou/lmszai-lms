                                ...
                                <div class="instructor-my-course-item-left">
                                    ...
                                    <div class="course-item-bottom">
                                        ...
                                        <div class="instructor-my-courses-btns d-inline-flex">
                                            ...
                                            @endif
                                            <a href="{{route('organization.course.students', [$course->uuid])}}" class="para-color font-14 font-medium d-flex align-items-center"><span class="iconify" data-icon="bx:bx-street-view"></span>{{ __('Students') }}</a>
                                        </div>
                                    </div>
                                </div>
