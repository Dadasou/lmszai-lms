                ...
                <div class="section-wrap-header">
                    <div class="progres-stype">
                        <form action="{{ route('process-update') }}" method="POST">
                            ...
                            @else
                                <p class="me-2 mb-2"><span class="text-danger">*</span> New
                                    version {{ config('app.current_version') }} </p>
                                <p class="me-2 mb-2"><span class="text-danger">*</span> Current
                                    version {{ get_option('current_version', '2.4') }} </p>
                                ...
                                <p class="me-2 mb-2"><span class="text-danger">*</span> Please click Update now button,
                                    may its need sometime</p>
                                <div class="mt-3">
{{--                                    <div class="single-section">--}}
{{--                                        <h4 class="section-title mb-2">Please enter your Item purchase code and customer--}}
{{--                                            email</h4>--}}
{{--                                        <div class="row">--}}
{{--                                            <div class="col-md-6">--}}
...
{{--                                                    <div--}}
{{--                                                        class="error text-danger">{{ $errors->first('purchase_code') }}</div>--}}
{{--                                                @endif--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
