<div class="course-item-one">
    ...
    <div class="content">
        <a class="title" href="{{ route('course-details', $course->slug) }}">{{ Str::limit($course->title, 40)}}
        </a>
        <a class="author" href="{{ route('userProfile',$course->user->id) }}">{{ $course->$userRelation->name }}</a>
