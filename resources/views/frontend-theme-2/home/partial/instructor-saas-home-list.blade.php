<div class="tab-pane fade show active" id="instructor-tab-pane" role="tabpanel" aria-labelledby="instructor-tab"
    ...
    <div class="tab-content" id="instructorpillsContent">
        <div class="tab-pane fade show active overflow-auto" id="pills-monthly-2" role="tabpanel"
        ...
        <div class="tab-pane fade overflow-auto" id="pills-yearly-2" role="tabpanel"
