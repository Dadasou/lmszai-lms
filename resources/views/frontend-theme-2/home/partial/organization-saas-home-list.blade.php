<div class="tab-pane fade" id="organization-tab-pane" role="tabpanel" aria-labelledby="organization-tab" tabindex="0">
    <div class="nav nav-pills justify-content-center align-items-center" id="organizationpills-tab" role="tablist">
        <span class="plan-switch-month-year-text mx-3"> {{ __('Monthly') }}</span>
        <div class="price-tab-lang">

            <span class="nav-item" role="presentation">

                <button class="nav-link active" id="pills2-monthly-2-tab" data-bs-toggle="pill"
                    data-bs-target="#pills2-monthly-2" type="button" role="tab" aria-controls="pills2-monthly-2"
                    aria-selected="true"></button>
            </span>
            <span class="nav-item" role="presentation">

                <button class="nav-link" id="pills2-yearly-2-tab" data-bs-toggle="pill"
                    data-bs-target="#pills2-yearly-2" type="button" role="tab" aria-controls="pills2-yearly-2"
    ...
    <div class="tab-content" id="organizationpillsContent">
        <div class="tab-pane fade show active overflow-auto" id="pills2-monthly-2" role="tabpanel"
            aria-labelledby="pills2-monthly-2-tab">
            <table class="table text-center theme-border bg-light mt-56 position-relative mb-136 price-table">
                ...
                <tbody class="price-body-info">
                    ...
                    <tr class="price-body-list">
                        <th scope="row">
                            <p class="title-price-list">{{ __('Create Instructor Access') }}</p>
                        </th>
                        @foreach ($organizationSaas as $index => $saas)
                            @if (!(get_option('saas_org_default_package_type') == 'yearly' && $saas->monthly_price <= 1))
                                <td>
                                    @if ($saas->instructor > 0)
                                        <p class="title-price-list">{{ $saas->instructor }}</p>
                                    @else
                    ...
                    <tr class="price-body-list">
                        <th scope="row">
                            <p class="title-price-list">{{ __('Create Student Access') }}</p>
                        </th>
                        @foreach ($organizationSaas as $index => $saas)
                            @if (!(get_option('saas_org_default_package_type') == 'yearly' && $saas->monthly_price <= 1))
                                <td>
                                    @if ($saas->student > 0)
                                        <p class="title-price-list">{{ $saas->student }}</p>
                                    @else
                                        <p class="title-price-list"><i class="fas fa-times"></i></p>
                                    @endif
                                </td>
        ...
        <div class="tab-pane fade overflow-auto" id="pills2-yearly-2" role="tabpanel"
            aria-labelledby="pills2-yearly-2-tab">
            <table class="table text-center theme-border bg-light mt-56 position-relative mb-136 price-table">
                <thead>
                    <tr class="price-title-bg">
                        <th scope="col">
