<div class="tab-pane fade show active overflow-auto" id="pills-monthly" role="tabpanel"
...
<div class="tab-pane fade overflow-auto" id="pills-yearly" role="tabpanel" aria-labelledby="pills-yearly-tab">
    <table class="table text-center theme-border bg-light mt-56 position-relative mb-136 price-table">
        <thead>
            <tr class="price-title-bg">
                <th scope="col">
