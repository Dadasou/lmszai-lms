<div class="bg-white border-0 card course-item course-item-upcoming h-100 sf-max-h-572 justify-content-between mb-0 radius-3">
    <div class="course-img-wrap overflow-hidden">
        ...
        <a href="{{ route('course-details', $course->slug) }}" class="d-flex w-100">
            <img src="{{ getImageFile($course->image_path) }}" alt="course" class="h-100 object-fit-cover w-100">
        </a>
