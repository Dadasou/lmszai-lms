<div
    class="card course-item course-item-upcoming {{ $course->status != STATUS_UPCOMING_APPROVED ? '' : 'course-item-upcoming' }} border-0 radius-3 bg-white">
    <div class="course-img-wrap overflow-hidden sf-max-h-221">
