...
<div class="page-banner-content text-center">
    <h3 class="page-banner-heading text-white pb-15"> {{__('Gmeet Settings')}} </h3>

    <!-- Breadcrumb Start-->
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb justify-content-center">
            <li class="breadcrumb-item font-14"><a href="{{route('instructor.dashboard')}}">{{__('Dashboard')}}</a></li>
            <li class="breadcrumb-item font-14 active" aria-current="page">{{__('Gmeet Settings')}}</li>
        </ol>
    </nav>
</div>
@endsection
...
<div class="instructor-profile-right-part">
    <form method="POST" action="{{route('instructor.gmeet_setting.update')}}">
        @csrf
        <div class="instructor-profile-info-box">
            <h6 class="instructor-info-box-title">{{__('Gmeet Settings')}}</h6>

            <div class="row">

                <div class="col-md-12 mb-30">
                    <div class="bg-disabled border-1 p-4">
                        <h2>Instructions: </h2>
                        <p>{{ __("Please use your email address as calender id. You have to authorize with that email to
                            active the google meet.") }}</p>
                    </div>
                </div>
                <div class="col-md-12 mb-30">
                    <label class="font-medium font-15 color-heading">{{__('Calender ID')}}</label>
                    <input type="text" name="calender_id" value="{{@$gmeet->calender_id}}" class="form-control"
                        placeholder="{{__('Calender ID')}}">
                    @if ($errors->has('calender_id'))
                    <span class="text-danger"><i class="fas fa-exclamation-triangle"></i> {{
                        $errors->first('calender_id') }}</span>
                    @endif
                </div>
                <div class="col-md-12 mb-30">
                    <label class="font-medium font-15 color-heading">{{__('Timezone')}}</label>
                    <select name="timezone" class=" select2">
                        <option value="{{ @$gmeet->timezone }}"> {{ @$gmeet->timezone }}</option>
                        ...
                        <option value="America/Cambridge_Bay">(GMT-7:00) America/Cambridge_Bay (Mountain Standard Time)
                        </option>
                        ...
                        <option value="America/Port-au-Prince">(GMT-5:00) America/Port-au-Prince (Eastern Standard Time)
                        </option>
                        ...
                        <option value="America/Port_of_Spain">(GMT-4:00) America/Port_of_Spain (Atlantic Standard Time)
                        </option>
                        ...
                        <option value="America/Santo_Domingo">(GMT-4:00) America/Santo_Domingo (Atlantic Standard Time)
                        </option>
                        <option value="America/St_Barthelemy">(GMT-4:00) America/St_Barthelemy (Atlantic Standard Time)
                        </option>
                        ...
                        <option value="Canada/Newfoundland">(GMT-3:-30) Canada/Newfoundland (Newfoundland Standard Time)
                        </option>
                        ...
                        <option value="America/Miquelon">(GMT-3:00) America/Miquelon (Pierre &amp; Miquelon Standard
                            Time)</option>
                        ...
                        <option value="Africa/Johannesburg">(GMT+2:00) Africa/Johannesburg (South Africa Standard Time)
                        </option>
                        ...
                        <option value="Indian/Kerguelen">(GMT+5:00) Indian/Kerguelen (French Southern &amp; Antarctic
                            Lands Time)</option>
                        ...
                        <option value="Antarctica/Casey">(GMT+8:00) Antarctica/Casey (Western Standard Time (Australia))
                        </option>
                        ...
                        <option value="Australia/Currie">(GMT+10:00) Australia/Currie (Eastern Standard Time (New South
                            Wales))</option>
                        <option value="Australia/Hobart">(GMT+10:00) Australia/Hobart (Eastern Standard Time (Tasmania))
                        </option>
                ...
                <div class="col-md-12 mb-30">
                    <label class="font-medium font-15 color-heading">{{__('Status')}}</label>
                    <select name="status" required id="status" class="">
                        <option value="">{{__('Select Option')}}</option>
                        <option value="1" {{ @$gmeet->status == 1 ? 'selected' : '' }}>{{ __('Authorize') }}</option>
                        <option value="0" {{ @$gmeet->status != 1 ? 'selected' : '' }}>{{ __('Disable') }}</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 d-flex justify-content-end">
            <button type="submit" class="theme-btn theme-button1 theme-button3 font-15 fw-bold">{{__('Authorize and Active')}}</button>
        </div>
    </form>
