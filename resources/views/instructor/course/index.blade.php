                            ...
                            <div class="card-body">
                                ...
                                <div class="instructor-courses-info-duration-wrap">
                                    <ul class="d-flex align-items-center justify-content-between">
                                        ...
                                        <li class="font-medium font-12"><span class="iconify" data-icon="ant-design:clock-circle-outlined"></span>{{__('Duration')}}<span class="instructor-courses-info-duration-wrap-text font-medium color-heading">({{ @$course->VideoDuration }})</span></li>
                                        <li class="font-medium font-12"><span class="iconify" data-icon="carbon:user-multiple"></span>{{__('Enrolled')}}<span class="instructor-courses-info-duration-wrap-text font-medium color-heading">({{  courseStudents($course->id) }})</span></li>
                                    </ul>
                                </div>
                                    ...
                                    <div class="course-item-bottom">
                                        ...
                                        <div class="instructor-my-courses-btns d-inline-flex">
                                             @if (is_null($course->organization_id))
                                                ...
                                                @endif
                                                <a href="{{route('instructor.course.students', [$course->uuid])}}" class="para-color font-14 font-medium d-flex align-items-center"><span class="iconify" data-icon="bx:bx-street-view"></span>{{ __('Students') }}</a>
                                            @else
