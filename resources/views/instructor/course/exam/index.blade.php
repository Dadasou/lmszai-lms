    ...
    <div class="instructor-profile-right-part">
        <div class="instructor-quiz-list-page">
            ...
            <div class="row">
                <div class="col-12">
                    @if($exams->count() > 0)
                        <div class="table-responsive table-pb-200">
                        <table class="table">
                            <thead>
                            <tr>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
                                            ...
                                            <li><a class="dropdown-item" href="{{route('exam.leaderboard', [$exam->uuid])}}"><span class="iconify" data-icon="carbon:result-new"></span>{{ __('Leaderboard') }}</a></li>
