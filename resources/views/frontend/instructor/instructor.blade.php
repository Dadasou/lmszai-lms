                            ...
                            <div class="accordion-item course-sidebar-accordion-item">
                                ...
                                <div id="panelsStayOpen-collapseEight" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingEight">
                                    <div class="accordion-body">
                                        <div class="sidebar-radio-item">
                                            <div class="form-check">
                                                <input class="form-check-input filterDifficultyLevel" type="radio" name="available_type" onclick="filterData()" id="exampleRadiosDifficulty9" value="3">
                                        ...
                                        <div class="sidebar-radio-item">
                                            <div class="form-check">
                                                <input class="form-check-input filterDifficultyLevel" type="radio" name="available_type" onclick="filterData()" id="exampleRadiosDifficulty10" value="1">
                                        ...
                                        <div class="sidebar-radio-item">
                                            <div class="form-check">
                                                <input class="form-check-input filterDifficultyLevel" type="radio" name="available_type" onclick="filterData()" id="exampleRadiosDifficulty11" value="2">
