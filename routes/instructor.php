...
Route::prefix('course')->group(function () {
    ...
    Route::get('course-students/{uuid}', [CourseController::class, 'courseStudent'])->name('instructor.course.students');
    ...
    Route::prefix('exam')->group(function () {
        ...
        Route::get('leaderboard/{uuid}', [ExamController::class, 'leaderboard'])->name('exam.leaderboard');
