...
use App\Http\Services\Payment\SslCommerz\AbstractSslCommerz;

class SslCommerzService extends AbstractSslCommerz
{
    protected $data = [];
    protected $config = [];
    ...
    public function makePayment($price, $requestData, $type = 'checkout', $pattern = 'json')
    {
        $data['success'] = false;
        $data['redirect_url'] = '';
        $data['payment_id'] = '';
