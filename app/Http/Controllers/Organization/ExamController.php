...
class ExamController extends Controller
{
    ...
    {
        $data['exam'] = $this->model->getRecordByUuid($uuid);
        $data['title'] = $data['exam']->name.' '.__('Leaderboard');
        $data['take_exams'] = Take_exam::whereExamId($data['exam']->id)->orderBy('number_of_correct_answer', 'DESC')->paginate();
        $data['navCourseActiveClass'] = 'active';
        return view('organization.course.exam.leaderboard', $data);
